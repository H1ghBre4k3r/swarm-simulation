...
func TestNew(t *testing.T) {
	entity := entities.Create("someRandomId", entities.Position{}, 0, entities.Position{}, 0x0, nil, nil, "", nil)
...
func TestSetters(t *testing.T) {
	entity := entities.Create("", entities.Position{}, 0, entities.Position{}, 0xffff0000, nil, nil, "", nil)
