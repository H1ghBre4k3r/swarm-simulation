...
noises = [0, 0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05]

args = parser.parse_args()
subprocess.call([args.e, "-c", args.s, "-o", args.o])

for noise in noises:
    for i in range(10):
        subprocess.call([args.e, "-c", args.s, "-o", args.o, "-n", str(noise), f"-consensus={args.c}"])
